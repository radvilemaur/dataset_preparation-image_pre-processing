...
#n4bias-field correction using ANTSPY 
...
#z-score normalization  https://intensity-normalization.readthedocs.io/en/latest/exec.html
#run directly in bash shell (Ubuntu) 
